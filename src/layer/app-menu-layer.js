		...
		var toggler = new cc.MenuItemToggle( on, off,
				function(that){
					...
					if(canAudioPlaying) {
						...
						sys.localStorage.setItem("canAudioPlaying", 0);
					} else {
						canAudioPlaying = true;
						sys.localStorage.setItem("canAudioPlaying", 1);
					}
				},this);
		...
		var toggler = new cc.MenuItemToggle( onAudio, offAudio,
				function(that){
					...
					if(canMusicPlaying) {
						...
						sys.localStorage.setItem("canMusicPlaying", 0);
						cc.audioEngine.pauseMusic();
					} else {
						canMusicPlaying = true;
						sys.localStorage.setItem("canMusicPlaying", 1);
